...
namespace PolitiekeBarometer_MVC
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            #region formatter
            string text = string.Format("Hello, {0}", message.Body);
            string html = "Please confirm your account by clicking this link: <a href=\"" + message.Body + "\">link<a/><br/>";

            html += HttpUtility.HtmlEncode(@"Or click on the copy of the following link on the browser;" + message.Body);
            #endregion
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<PolitiekeBarometerContext>()));
